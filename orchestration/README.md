...
| :--- | :--- | :--- | :--- | :--- |
| **0. Setup** | `00_Data_Generator.ipynb` | Generación y carga del modelo transaccional de origen (Dummy Data) solicitado por la prueba. | ✅ **Completado** | ![Conteo Datos](docs/evidencia_poblado_tablas.png) *(1,000,000 reg. en ventas)* |
