...
Se estructuró y pobló el modelo relacional cumpliendo con las volumetrías requeridas (incluyendo 1,000,000 de registros en la tabla de transacciones de ventas).
